...
func _process(delta):
	...
	var zoom_factor1 = abs(object1.global_position.x-object2.global_position.x)/(600-50)
	var zoom_factor2 = abs(object1.global_position.y-object2.global_position.y)/(350-50)
	var zoom_factor = max(max(zoom_factor1, zoom_factor2), 0.9)
